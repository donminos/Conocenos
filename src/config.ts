...
export function Information(opc) {
    switch (opc) {
        ...
        case 4: return [
            ...
            { "id": 2, "title": "Fomentar la implementación de nuevas técnicas y tecnologías innovadoras en la agricultura.", "image": "nula.png" },
        ...
        case 7: return [
            ...
            { "id": 9, "title": "Establecer y vincular con las escuelas de educación básica a través de la red de bibliotecas de la demarcación elPrograma de Taller de lectura.", "image": "nula.png" }
        ];
        ...
        case 10: return [
            { "id": 1, "title": "Establecer el consejo ciudadano anticorrupción, el cual mediante los mecanismos jurídicos y administrativospodrán dar seguimiento al ejercicio gubernamental.", "image": "nula.png" },
        ...
        case 11: return [
            { "id": 1, "title": "Mantenimiento de la carpeta asfaltica", "image": "nula.png" },
            { "id": 2, "title": "Mantenimiento de andadores y jardines", "image": "nula.png" }
        ];
    }
}