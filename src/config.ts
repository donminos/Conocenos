export const sender_id = '425940642528';
export const oneSignalAppId = 'd240c82c-aa53-4478-a545-c6c13c74e2c1';

export const Superdata: any = [
    { "id": 1, "image": "1.jpeg" },
    { "id": 2, "image": "2.jpeg" },
    { "id": 3, "image": "3.jpeg" },
    { "id": 4, "image": "4.jpeg" },
...
export function Information(opc) {
    switch (opc) {
        ...
        case 3: return [
            ...
            { "id": 3, "title": "Fomentar la generación de infraestructura que permita la recepción de medio y gran turismo.", "image": "desarrollo y promocion turistica. fomentar la infraestructura que permita la recepcion de medio ambiente y gran turismo.jpg" },
            { "id": 4, "title": "Fomentar la generación de un turismo alternativo y en comunión con la naturaleza.", "image": "desarrollo y promocion turistica. fomentar la generacion de un turismo alternativo en comun con la naturaleza.jpg" }
        ];
        ...
        case 7: return [
            ...
            { "id": 3, "title": "En coordinación con instituciones de educación superior que tengan dentro de sus programas pasantes de las especialidades de odontología (UNAM, UAM, IPN), se establecerá el programa de Salud Bucal para Xochimilco, mediante consultorios médicos móviles.", "image": "UNAM, UAM, IPN.jpeg" },
